					...
					<div class="col-lg-6">
						<div class="product_image_slider_container">
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<img src="{{asset('shop/images/product_image_1.jpg')}}" />
									</li>
									<li>
										<img src="{{asset('shop/images/product_image_1.jpg')}}" />
									</li>
							...
							<div class="carousel_container">
								<div id="carousel" class="flexslider">
									<ul class="slides">
										<li>
											<div><img src="{{asset('shop/images/product_1.jpg')}}" /></div>
										</li>
										<li>
											<div><img src="{{asset('shop/images/product_2.jpg')}}" /></div>
										</li>
										<li>
											<div><img src="{{asset('shop/images/product_3.jpg')}}" /></div>
										</li>
										<li>
											<div><img src="{{asset('shop/images/product_4.jpg')}}" /></div>
										</li>
										<li>
											<div><img src="{{asset('shop/images/product_5.jpg')}}" /></div>
										</li>
										<li>
											<div><img src="{{asset('shop/images/product_6.jpg')}}" /></div>
										</li>
										<li>
											<div><img src="{{asset('shop/images/product_7.jpg')}}" /></div>
										</li>
										<li>
											<div><img src="{{asset('shop/images/product_8.jpg')}}" /></div>
										</li>
									</ul>
								</div>
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="box d-flex flex-row align-items-center justify-content-start">
							<div class="mt-auto"><div class="box_image"><img src="{{asset('images/boxes_1.png')}" alt=""></div></div>
					...
					<div class="col-lg-6 box_col">
						<div class="box d-flex flex-row align-items-center justify-content-start">
							<div class="mt-auto"><div class="box_image"><img src="{{asset('images/boxes_2.png')}" alt=""></div></div>
							<div class="box_content">
